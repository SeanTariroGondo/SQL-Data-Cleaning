...
--USE PortfolioProject;
--GO
--BULK INSERT [Housing].[dbo].[Tbl_Housing_Data] FROM 'C:\Temp\SQL Server Management Studio\Nashville Housing Data for Data Cleaning Project.csv'
--   WITH (
--      FIELDTERMINATOR = ',',
--      ROWTERMINATOR = '\n'
--);
...
--USE PortfolioProject;
--GO
--SELECT * INTO [Housing].[dbo].[Tbl_Housing_Data]
